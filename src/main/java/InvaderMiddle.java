...
/**
 * InvaderMiddle is an implementation of the Invader abstract class.
 * 
...
public class InvaderMiddle extends Invader {
    ...
    private Image imageA = getImage("img_invadermiddleA.gif");
    private Image imageB = getImage("img_invadermiddleB.gif");
    private boolean alternate = false;

    /**
     * Create a new InvaderMiddle object.
     * 
     * @param x
